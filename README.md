...
- **Modern theming system** with predefined color schemes (Blue, Purple, Green, Orange, Rose) and custom color support using OKLCH color space for perceptually uniform colors across light and dark modes.
